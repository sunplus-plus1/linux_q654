...
static ssize_t isp_del_idx_show(struct device *dev, struct device_attribute *attr,
								char *buf)
{
...
static ssize_t isp_add_idx_show(struct device *dev, struct device_attribute *attr,
								char *buf)
{
	isp_debugfs_travel_list();
	return 0;
...
{
	int target_idx = 0;
	struct isp_dbg_info *entry = kzalloc(sizeof(struct isp_dbg_info), GFP_KERNEL);
...
static ssize_t isp_clk_gate_show(struct device *dev, struct device_attribute *attr,
								 char *buf)
{
...
static ssize_t isp_dump_log_show(struct device *dev, struct device_attribute *attr,
								 char *buf)
{
	printk("(isp_dbg) === isp version %d === %s(%d) \n", ISP_VERSION, __func__, __LINE__);
...
static ssize_t
isp_hard_reg_show(struct device *dev, struct device_attribute *attr,
				  char *buf)
{
...
static ssize_t
isp_hard_input_show(struct device *dev, struct device_attribute *attr,
					char *buf)
{
...
static ssize_t
isp_hard_input_2_show(struct device *dev, struct device_attribute *attr,
					  char *buf)
{
...
static ssize_t
isp_hard_mlsc_show(struct device *dev, struct device_attribute *attr,
				   char *buf)
{
...
static ssize_t
isp_hard_fcurve_show(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
	if (mlsc_file_name == NULL)
...
static ssize_t
isp_hard_wdr_show(struct device *dev, struct device_attribute *attr,
				  char *buf)
{
...
static ssize_t
isp_hard_lce_show(struct device *dev, struct device_attribute *attr,
				  char *buf)
{
...
static ssize_t
isp_hard_cnr_show(struct device *dev, struct device_attribute *attr,
				  char *buf)
{
...
static ssize_t
isp_hard_3dnr_y_show(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
...
static ssize_t
isp_hard_3dnr_uv_show(struct device *dev, struct device_attribute *attr,
					  char *buf)
{
...
static ssize_t
isp_hard_3dnr_v_show(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
...
static ssize_t
isp_hard_3dnr_mot_show(struct device *dev, struct device_attribute *attr,
					   char *buf)
{
...
static ssize_t
isp_dump_folder_show(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
	if (dump_folder == NULL)
...
static ssize_t
isp_dump_reg_show(struct device *dev, struct device_attribute *attr,
				  char *buf)
{
...
static ssize_t
isp_dump_statis_show(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
	return 0;
}
...
static ssize_t
isp_dump_3dnr_show(struct device *dev, struct device_attribute *attr,
				   char *buf)
{
	return 0;
}
...
static ssize_t
isp_dump_3a_show(struct device *dev, struct device_attribute *attr,
				 char *buf)
{
	return 0;
}
...
static ssize_t
isp_dump_output_show(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
	return 0;
}
...
static ssize_t
isp_dump_input_show(struct device *dev, struct device_attribute *attr,
					char *buf)
{
	return 0;
}
...
static ssize_t
isp_list_all_show(struct device *dev, struct device_attribute *attr,
				  char *buf)
{
...
static ssize_t
isp_clean_all_show(struct device *dev, struct device_attribute *attr,
				   char *buf)
{
	return 0;
}
