...
#define D3NR_Y_MAX_SIZE (2688 * 1944)	   // 2688*1944*8 bits
#define D3NR_UV_MAX_SIZE (2688 * 1944 * 2) // 2688*1944*16 bits
#define D3NR_U_MAX_SIZE (2688 * 1944)	   // 2688*1944*8 bits
#define D3NR_V_MAX_SIZE (2688 * 1944)	   // 2688*1944*8 bits
#define D3NR_MOT_MAX_SIZE (2688 * 1944)	   // 2688*1944*8 bits
#define D3NR_REDUCE_BANDWITH (false)

#define ISP_PAGE_MASK (~(PAGE_SIZE - 1))
#define ISP_PAGE_ALIGN(x) (((x) + PAGE_SIZE - 1) & ISP_PAGE_MASK)

#define CNR_SIZE_FORMULA(width, height) (ISP_PAGE_ALIGN((size_t)((width) / 4) * ((height) / 4) * 2)) // (w/4)*(h/4)*16 bits
