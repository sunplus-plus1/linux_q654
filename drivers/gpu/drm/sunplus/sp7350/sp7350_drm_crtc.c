...
static void sp7350_crtc_dmix_init(struct drm_crtc *crtc)
{
	...
	value = SP7350_CRTC_READ(TGEN_DTG_ADJUST1);
	value &= ~SP7350_TGEN_DTG_ADJ_MASKA;
	value |= SP7350_TGEN_DTG_ADJ_MASKA_SET(SP7350_TGEN_DTG_ADJ_DMIX_L3);
	SP7350_CRTC_WRITE(TGEN_DTG_ADJUST1, value);
	value = 0;
	value |= SP7350_TGEN_DTG_ADJ_MASKA_SET(SP7350_TGEN_DTG_ADJ_DMIX_L1)
		   | SP7350_TGEN_DTG_ADJ_MASKB_SET(SP7350_TGEN_DTG_ADJ_DMIX_L4);
	SP7350_CRTC_WRITE(TGEN_DTG_ADJUST2, value);
	value = 0;
	value |= SP7350_TGEN_DTG_ADJ_MASKA_SET(SP7350_TGEN_DTG_ADJ_DMIX_L5)
		   | SP7350_TGEN_DTG_ADJ_MASKB_SET(SP7350_TGEN_DTG_ADJ_DMIX_L6);
	SP7350_CRTC_WRITE(TGEN_DTG_ADJUST3, value);
	value = SP7350_CRTC_READ(TGEN_DTG_ADJUST4);
	value &= ~SP7350_TGEN_DTG_ADJ_MASKA;
	value |= SP7350_TGEN_DTG_ADJ_MASKA_SET(SP7350_TGEN_DTG_ADJ_DMIX_BG);
	SP7350_CRTC_WRITE(TGEN_DTG_ADJUST4, value);
		  ...
		  const struct drm_crtc_helper_funcs *crtc_helper_funcs)
{
	...
	sp_crtc->media_plane->possible_crtcs = GENMASK(drm->mode_config.num_crtc - 1, 0);
	sp_crtc->overlay_planes[0]->possible_crtcs = GENMASK(drm->mode_config.num_crtc - 1, 0);
	sp_crtc->overlay_planes[1]->possible_crtcs = GENMASK(drm->mode_config.num_crtc - 1, 0);
