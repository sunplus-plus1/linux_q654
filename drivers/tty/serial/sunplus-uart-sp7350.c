...
// dv 485: rs485_config()
static int sunplus_uart_config_rs485(struct uart_port *_up, struct ktermios *termios,
...
#ifdef CONFIG_SERIAL_SUNPLUS_SP7350_CONSOLE
static void sunplus_uart_console_putchar(struct uart_port *port, unsigned char ch)
{
	wait_for_xmitr(port);
...
static const struct dev_pm_ops sp7350_uart_pm_ops = {
	.runtime_suspend = sunplus_uart_runtime_suspend,
	.runtime_resume  = sunplus_uart_runtime_resume,
};
#define sunplus_uart_pm_ops  (&sp7350_uart_pm_ops)
#endif
