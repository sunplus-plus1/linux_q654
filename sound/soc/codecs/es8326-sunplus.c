...
static int es8326_resume(struct snd_soc_component *component)
{
	...
	regmap_write(es8326->regmap, ES8326_CLK_INV, 0x10);
...
static int es8326_probe(struct snd_soc_component *component)
{
	...
	// es8326_set_bias_level off
	clk_disable_unprepare(es8326->mclk);
	regmap_write(es8326->regmap, ES8326_ANA_PDN, 0x3b);
	regmap_write(es8326->regmap, ES8326_VMIDSEL, 0x00);
	regmap_update_bits(es8326->regmap, ES8326_CLK_CTL, 0x20, 0x00);
	regmap_write(es8326->regmap, ES8326_SDINOUT1_IO, ES8326_IO_INPUT);
	// es8326_set_bias_level on
	regmap_write(es8326->regmap, ES8326_RESET, 0x9f);
	msleep(20);
	regmap_update_bits(es8326->regmap, ES8326_DAC_DSM, 0x01, 0x00);
	regmap_write(es8326->regmap, ES8326_INTOUT_IO, es8326->interrupt_clk);
	...
	regmap_write(es8326->regmap, ES8326_ANA_PDN, 0x00);
	regmap_update_bits(es8326->regmap,  ES8326_CLK_CTL, 0x20, 0x20);
	regmap_write(es8326->regmap, ES8326_RESET, ES8326_CSM_ON);//ES8326_MASTER_MODE_EN
	//
	// open adc and dac channels
	regmap_update_bits(es8326->regmap, ES8326_DAC2HPMIX,
			   0x88, 0x88);
	regmap_update_bits(es8326->regmap, ES8326_ANA_PDN,
			   0x03, 0x00);
	...
	regmap_write(es8326->regmap, ES8326_HP_DRIVER, 0xa0);//81
	regmap_write(es8326->regmap, ES8326_HP_VOL, 0xc4);
	regmap_write(es8326->regmap, ES8326_HP_CAL, ES8326_HP_ON);
	regmap_update_bits(es8326->regmap, ES8326_DAC_MUTE,
			   ES8326_MUTE_MASK, ~(ES8326_MUTE));
	//set format
	snd_soc_component_update_bits(component, ES8326_FMT, ES8326_DAIFMT_MASK, 0);
	snd_soc_component_update_bits(component, ES8326_FMT, ES8326_DATA_LEN_MASK, ES8326_S16_LE);
